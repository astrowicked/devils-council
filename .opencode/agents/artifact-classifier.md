---
description: 'Haiku-tier fallback classifier. Invoked ONLY when lib/classify.py finds
  zero structural signals. Emits a JSON object naming which bench personas to spawn
  (subset of the 8 bench personas: security-reviewer, finops-auditor, air-gap-reviewer,
  dual-deploy-reviewer, compliance-reviewer, performance-reviewer, test-lead, competing-team-lead)
  with one-sentence reasoning per persona.'
mode: subagent
permission:
  edit: deny
  bash: deny
